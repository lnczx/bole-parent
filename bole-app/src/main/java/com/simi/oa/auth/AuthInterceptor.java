...
//
//					// for (PermissionMenu permissionMenu :
//					// accountAuth.getAccountRole().getPermissionMenus()) {
//					// // System.out.println(permissionMenu.getPermission() +
//					// // "----" + requestServletPath);
//					// Pattern pattern =
//					// Pattern.compile(permissionMenu.getPermission(),
//					// Pattern.CASE_INSENSITIVE);
//					// Matcher matcher = pattern.matcher(requestServletPath);
//					// if (matcher.find()) {
//					// hasPermission = true;
//					// if (permissionMenu.getUrl().equals(requestServletPath))
//					// AuthHelper.setRequestPermissionMenu(request,
//					// permissionMenu);
//					//
//					// break;
//					// }
